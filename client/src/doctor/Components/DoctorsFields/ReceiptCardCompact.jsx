        ...
        <>
          ...
          <div style={{ 
            ...
            <div style={{
              ...
              <h4 style={{ marginTop: "0", marginBottom: "12px", color: "#00A99D", fontSize: "16px", fontWeight: "600", borderBottom: "2px solid #00A99D", paddingBottom: "8px" }}>
                Doctor Details
              </h4>
              <div style={{ lineHeight: "1.8", fontSize: "14px" }}>
                <p style={{ margin: "6px 0" }}><strong>Name:</strong> {doctorDetails?.name || "N/A"}</p>
          ...
          <div style={{
            ...
            <h4 style={{ marginTop: "0", marginBottom: "20px", color: "#00A99D", fontSize: "18px", fontWeight: "600", borderBottom: "2px solid #00A99D", paddingBottom: "10px" }}>
              Payment Details
            </h4>
            <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1px 1fr", gap: "40px", fontSize: "15px" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <span style={{ fontWeight: "600", color: "#333" }}>Consultation Fee:</span>
                  <span style={{ color: "#00A99D", fontWeight: "600", fontSize: "18px" }}>₹{paymentDetails?.amount || 0}.00</span>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <span style={{ color: "#666" }}>{formatDate(appointmentDetails?.date)}</span>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <span style={{ fontWeight: "600", color: "#333" }}>Time:</span>
