...
//           {/* Main Content */}
//           <main
//   className="col-lg-10 pt-4 px-4"
//   style={{
//     marginLeft: isMobile ? '0' : '350px',
//     marginTop: isMobile ? '140px' : '86px', // ⬅ increased for mobile
//     marginBottom: "50px"
//   }}
// >
...
import SearchIcon from "../../assets/confirmappointmenticons/search.svg";
import Microphone from "../../assets/cardiologist/microphone.svg";
// import { BsBorderLeft } from "react-icons/bs"; // This was an unused import, safe to remove
import { useNavigate } from "react-router-dom";
import FilterIcon from "../../assets/filter-icon.svg";
...
export default function LabCardsComponent() {
  // New state to control the "Coming Soon" overlay
  const [showComingSoon, setShowComingSoon] = useState(true); // <-- Set to true to activate
  ...
  const handleClick = () => {
    // Only navigate if the "Coming Soon" feature is NOT active
    if (!showComingSoon) {
      navigate("/lab/panel");
    }
  };
    ...
    <div style={{ overflowX: "hidden" }}>
      ...
      {showComingSoon && (
        <div
          ...
          style={{
            // High zIndex to intercept ALL clicks/interactions on the page
            // zIndex: 10001, 
