...
import Category from "../../../assets/DBIcons/neurologist.svg";
...
const MainContent = ({selectedFilters, setSelectedFilters, clearAllFilters, onToggleSidebar,categorySlug }) => {
  ...
  const { uuid } = useParams(); // get category uuid from route
const [selected, setSelected] = useState(
  localStorage.getItem("selectedConsultationType") || ""
    ...
    <div className="p-4 main-contents" style={{ flex: 1, }}>
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div className=" d-none  align-items-center gap-3 text">
          <img src={Category} alt="Neurologist Icon" width={52} height={52} />
          <div>
