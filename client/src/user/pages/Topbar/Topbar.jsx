...
const Topbar = ({ toggleSidebar: propToggleSidebar, isMobile: propIsMobile } = {}) => {
  ...
  const fetchNotifications = async () => {
    ...
    try {
      ...
      if (res.status === 404) {
        console.warn(
          'Notifications endpoint not found (404). This may be expected if notifications are not yet implemented.',
        );
        setNotifications([]);
        return;
      }
    ...
    >
              ...
              <>
                ...
                <div
                  ...
                  style={{
                    ...
                    width: '100%',
                    height: '100vh',
                    backgroundColor: toggleState ? 'rgba(0, 0, 0, 0.3)' : 'rgba(0, 0, 0, 0)',
                    zIndex: 998,
                ...
                <div
                  style={{
                    ...
                    transform: toggleState ? 'translateX(0)' : 'translateX(-100%)',
                  ...
                  <ol className='list-unstyled'>
                    {menuItems.map((item, index) => (
                      <li
                        ...
                        onMouseEnter={(e) => {
                          e.currentTarget.style.backgroundColor = 'rgba(0,169,157,0.05)';
                        }}
                        onMouseLeave={(e) => {
      ...
      <div className='d-flex align-items-center ms-auto'>
        ...
        <div style={{ position: 'relative', marginRight: '15px' }} ref={dropdownRef}>
          ...
          <IconButton
            onClick={() => setShowDropdown((prev) => !prev)}
            sx={{ color: '#00A99D', width: '22px', height: '22px' }} // optional teal color
          >
