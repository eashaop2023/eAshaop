...
//     //setIsOpen(!mobile);
//   }, []);
// const [showComingSoon, setShowComingSoon] = useState(true); // Set to true to activate overlay
...
export default function HomeSection() {
  ...
  return (
    <>
      <div style={{ overflowX: "hidden" }}>
        <div
          className={`position-relative ${styles.mainContainer}`}
          style={{
            marginLeft: isMobile ? "10px" : "100px",
            marginTop: "53px",
            backgroundColor: "#ffffff",
        ...
        >
          ...
          {/* Banner Section */}
          <div
            className="px-3 px-lg-5 py-4"
            style={{ backgroundColor: "#EDFFFE", height: "auto" }}
          >
            <div className="mb-3">
              <h1 className="fw-bold text-dark">
                Take care of your health without hurting your wallet
              </h1>
              <p className="fs-5 text-dark">Compare price and save up 50%</p>
            </div>

            {/* Search Bar */}
            <div className="d-flex flex-wrap gap-2">
              <div
                className="d-flex align-items-center bg-transparent rounded-pill px-3 flex-grow-1"
                style={{
                  border: "1px solid #8E8E8E",
                  height: "56px",
                  maxWidth: "950px",
          ...
          {/* Categories */}
          <div className="d-flex flex-wrap gap-3 px-3 px-lg-5 my-4">
            {categories.map((cat, idx) => (
              ...
              >
                ...
                />
                <p className="small fw-regular mb-0 mt-2">{cat.name}</p>
              </div>
            ))}
          </div>

          {/* Upload Prescription */}
          {/* <div className="px-3 px-lg-5 mb-5">
            <div
              className="d-flex justify-content-between align-items-center position-relative px-4 py-4"
              style={{
                border: "2px dashed #00A99D",
                borderRadius: "28px",
                backgroundColor: "#fff",
            ...
            >
              ...
              <div style={{ zIndex: 1 }}>
                <h6 className="fw-bold text-success fs-3 mb-1">Get 15% off</h6>
              ...
              <button
                className="btn d-flex align-items-center gap-2 fs-5 fw-regular"
                style={{
                  backgroundColor: "transparent",
                  color: "#00A99D",
                  border: "none",
              ...
              >
                <img src={uploadIcon} alt="upload" width="40" />
                Upload prescription
              </button>
          ...
          {/* Offer Section */}
          <div className="d-flex flex-column flex-lg-row justify-content-between align-items-center px-3 px-lg-5">
            <div>
              <h4 className="text-dark mb-2 fw-normal">
                Our Prices Dropped Harder Than Your Fever
              </h4>
              <h1 className="fw-bold text-success">50% OFF!</h1>
              <p style={{ fontSize: "15px" }}>
                <del className="text-muted fs-5">₹ 500</del>{" "}
                <span className="fw-bold text-dark fs-4">₹ 250</span>
                <span className="fw-normal text-dark ms-3 fs-4">Including tax</span>
              </p>
              <button
